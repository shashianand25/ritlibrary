    ...
    >
      ...
      {[
        ...
        },
        {
          ...
          color: '#84CC16',
          op: 0.09,
          anim: 'blob-float-3 22s ease-in-out infinite',
        },
      ].map((b, i) => (
        <div
          key={i}
        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ maxWidth: 860, margin: '0 auto', padding: '20px 24px 80px' }}>
            ...
            >
              ...
              >
                A student-built platform where RIT students can find, upload, and keep notes, PYQs,
                and campus opportunities organized — completely free.
              </p>
            </motion.div>
              ...
              >
                {CREATORS.map((c, i) => (
                  ...
                  >
                    ...
                    <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, margin: 0 }}>
                      {c.desc}
                    </p>
                  </motion.div>
                ))}
            ...
            >
              ...
              <p style={{ fontSize: 16, lineHeight: 1.8, opacity: 0.75, margin: 0 }}>
                Every student at RIT deserves quick access to useful academic material without
                digging through scattered links and forwarded files. RIT Library now lets students
                upload notes and PYQs directly into subject folders, tag them by section or mark
                them for everyone, search by subject code, and discover events, hackathons, and
                challenges from the same place. No paywalls. No clutter. Just shared resources that
                stay easy to find.
              </p>
            </motion.div>
            ...
            >
              RIT Library · Made with{' '}
              <Heart
                size={11}
                style={{ display: 'inline', verticalAlign: 'middle', color: '#ef4444' }}
              />{' '}
