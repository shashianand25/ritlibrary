...
export function FileRow({
  ...
  const sectionLabel =
    file.section && file.section.toLowerCase() !== 'gen' ? file.section.toUpperCase() : 'Gen';
  const meta = [sectionLabel, file.uploaderName ? `by ${file.uploaderName}` : '']
    .filter(Boolean)
    .join(' · ');
  return (
    <motion.div
