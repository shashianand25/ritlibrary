...
export function CircleLoader({ size = 44, color = '#596628' }) {
  const rings = [
    ...
    { s: size * 0.9, top: '1.75%', left: '0.875%', delay: '0.2s' },
    { s: size * 0.8, top: '3.5%', left: '1.75%', delay: '0.4s' },
    { s: size * 0.7, top: '5.25%', left: '2.625%', delay: '0.6s' },
    { s: size * 0.6, top: '7%', left: '3.5%', delay: '0.8s' },
  ];
  return (
